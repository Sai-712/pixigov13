...
const EventDashboard = (props: EventDashboardProps) => {
    ...
    const handleCreateEvent = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (newEvent.coverImage) {
                const coverImageKey = `events/${userEmail}/${eventId}/cover-${newEvent.coverImage.name}`;
            ...
            const eventFolderKey = `events/${userEmail}/${eventId}/`;
            const folderPaths = [
                eventFolderKey,
    ...
    return (
        ...
        <div className="relative min-h-screen">
            ...
            {/* Main Content with higher stacking context */}
            <div className="relative z-10 container mx-auto px-4 py-8">
                <div className="mb-8 flex justify-between items-center">
                    <h1 className="text-3xl font-bold text-red-100">Event Dashboard</h1>
                    <button
                ...
                {showAllEvents && (
                    <div className="mt-8">
                        <h2 className="text-2xl font-bold text-red-400 mb-6">All Events</h2>
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <div className="mt-4 flex justify-end space-x-4">
                                                <Link
                                                    ...
                                                    className="bg-red-300 text-red-800 px-4 py-2 rounded-lg hover:bg-secondary transition-colors duration-200"
                                                >
                                                    View Event
                                                </Link>
                                                <button
